...
# 예시: ren snu_platform-main snu_platform
# 예시: ren snu_platform-main arch-insight
...
# 예시: conda create -n snu_platform python=3.9 -y
# 예시: conda create -n arch-insight python=3.9 -y
...
conda activate [환경명]
# 예시: conda activate snu_platform
# 예시: conda activate arch-insight
